...
urlpatterns = patterns('',
    ...
    url(r'^directory/object/delete/(?P<lbeObject_id>\d+)/(?P<objectName>.+)$', 'directory.views.deleteObjectInstance'),
    url(r'^directory/object/manage/(?P<lbeObject_id>\d+)/(?P<objectName>.+)?/?(?P<type>[\w\s]+)?/?$', 'directory.views.manageObjectInstance'),
    url(r'^directory/object/view/(?P<lbeObject_id>\d+)/(?P<objectName>.+)$', 'directory.views.viewObjectInstance'),
    url(r'^directory/object/approval/(?P<lbeObject_id>\d+)/(?P<objectName>.+)$', 'directory.views.approvalObjectInstance'),
