...
urlpatterns = patterns('',
    ...
    url(r'^directory/object/manage/(?P<lbeObject_id>\d+)/(?P<objectName>[\w\s]+)?/?(?P<type>[\w\s]+)?/?$', 'directory.views.manageObjectInstance'),
    url(r'^directory/object/view/(?P<lbeObject_id>\d+)/(?P<objectName>[\w\d ]+)$', 'directory.views.viewObjectInstance'),
    url(r'^directory/object/approval/(?P<lbeObject_id>\d+)/(?P<objectName>[\w\d ]+)$', 'directory.views.approvalObjectInstance'),
