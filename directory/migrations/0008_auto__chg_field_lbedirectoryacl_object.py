...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'directory_lbedirectoryacl', 'object_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.LBEObjectTemplate'], null=True))

    def backwards(self, orm):

        # Changing field 'LBEDirectoryACL.object'
        db.alter_column(u'directory_lbedirectoryacl', 'object_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['directory.LBEObjectTemplate']))
    ...
    models = {
        u'directory.lbeattribute': {
            ...
            'errorMessage': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '64'}),
            'regex': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64', 'blank': 'True'})
        },
        ...
        u'directory.lbedirectoryacl': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['directory.LBEGroup']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['directory.LBEObjectTemplate']", 'null': 'True', 'blank': 'True'}),
