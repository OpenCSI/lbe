...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LBEDirectoryACL.group'
        db.add_column(u'directory_lbedirectoryacl', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['directory.LBEGroup'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LBEDirectoryACL.group'
        db.delete_column(u'directory_lbedirectoryacl', 'group_id')
    ...
    models = {
        ...
        u'directory.lbedirectoryacl': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['directory.LBEGroup']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
