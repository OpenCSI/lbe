...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'directory_lbeobjecttemplate', (
            ...
            ('instanceNameBeforeAttribute', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='instance_name_before_attribute', null=True, blank=True, to=orm['directory.LBEAttribute'])),
            ('instanceNameAttribute', self.gf('django.db.models.fields.related.ForeignKey')(related_name='instance_name_attribute', to=orm['directory.LBEAttribute'])),
            ('instanceDisplayNameAttribute', self.gf('django.db.models.fields.related.ForeignKey')(related_name='instance_displayname_attribute', to=orm['directory.LBEAttribute'])),
        ...
        db.create_table(u'directory_lbeattributeinstance', (
            ...
            ('lbeObjectTemplate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.LBEObjectTemplate'])),
            ('defaultValue', self.gf('django.db.models.fields.CharField')(default='', max_length=64, null=True, blank=True)),
            ...
            ('reference', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['directory.LBEReference'], null=True, blank=True)),
        ...
        db.create_table(u'directory_lbedirectoryacl', (
            ...
            ('attribut', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['directory.LBEAttributeInstance'], null=True)),
