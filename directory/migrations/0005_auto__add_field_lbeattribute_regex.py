...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LBEAttribute.regex'
        db.add_column(u'directory_lbeattribute', 'regex',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LBEAttribute.regex'
        db.delete_column(u'directory_lbeattribute', 'regex')
