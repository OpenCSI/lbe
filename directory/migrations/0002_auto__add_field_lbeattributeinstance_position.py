...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'LBEAttributeInstance.position'
        db.add_column(u'directory_lbeattributeinstance', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LBEAttributeInstance.position'
        db.delete_column(u'directory_lbeattributeinstance', 'position')
