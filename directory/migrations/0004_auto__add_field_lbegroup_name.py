...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LBEGroup.name'
        db.add_column(u'directory_lbegroup', 'name',
                      self.gf('django.db.models.fields.CharField')(default='groups', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LBEGroup.name'
        db.delete_column(u'directory_lbegroup', 'name')
