...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LBEGroup.reconciliation_object_missing_policy'
        db.delete_column(u'directory_lbegroup', 'reconciliation_object_missing_policy')

        # Deleting field 'LBEGroup.reconciliation_object_different_policy'
        db.delete_column(u'directory_lbegroup', 'reconciliation_object_different_policy')


    def backwards(self, orm):
        # Adding field 'LBEGroup.reconciliation_object_missing_policy'
        db.add_column(u'directory_lbegroup', 'reconciliation_object_missing_policy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LBEGroup.reconciliation_object_different_policy'
        db.add_column(u'directory_lbegroup', 'reconciliation_object_different_policy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
